...
PACKAGES="$PACKAGES_MINIMAL $PACKAGES_COMMON isc-dhcp44-server isc-dhcp44-client isc-dhcp44-relay \
    ...
    php74-extensions php74-xmlrpc php74-bz2 php74-gettext php74-openssl \
    php74-soap php74-imap php74-fileinfo openvpn easy-rsa net-snmp zabbix52-agent zabbix54-agent"
